...
//     // Basic size guard (max 5 MB)
//     if (file.size > 5 * 1024 * 1024) {
//       setErrors((p) => ({...p, photo: 'Ukuran foto maksimal 5 MB'}))
//       return
//     }
...
//     try {
//       /**
//        * POST /items/{id}/faulty
//        * Kirim sebagai multipart/form-data agar foto ikut terupload ke server.
//        * Backend harus menerima: faulty_quantity, description, photo (file).
//        * Jika backend tidak support file upload, ganti ke JSON biasa tanpa photo.
//        */
//       const formData = new FormData()
//       formData.append('faulty_quantity', String(qty))
//       formData.append('description', description)
//       formData.append('reported_by', currentUser?.fullname || currentUser?.username || 'Unknown')
//       if (photoFile) {
...
//       const errMsg =
//         err?.response?.data?.message || 'Gagal memproses laporan. Coba lagi.'
...
//         >
//           <div>
//             <h3 style={{fontSize: '17px', fontWeight: 700, color: '#dc3545', margin: 0}}>
//               Lapor Barang Rusak
//             </h3>
...
//             style={{
//               ...inputCellStyle,
//               borderBottom: errors.quantity ? '2px solid #dc3545' : 'none',
//             }}
//             placeholder='0'
//           />
//         </div>
...
//               ...inputCellStyle,
//               resize: 'vertical',
//               borderLeft: errors.description ? '2px solid #dc3545' : 'none',
//             }}
...
//             ...inputRowStyle,
//             alignItems: 'stretch',
//             marginBottom: errors.photo ? '4px' : '20px',
//           }}
//         >
...
//                   textAlign: 'center',
//                   cursor: 'pointer',
//                   backgroundColor: errors.photo ? '#fff5f5' : '#faf6f2',
//                   transition: 'border-color 0.15s',
//                 }}
//                 onMouseEnter={(e) =>
//                   ((e.currentTarget as HTMLDivElement).style.borderColor = '#897870')
//                 }
//                 onMouseLeave={(e) =>
//                   ((e.currentTarget as HTMLDivElement).style.borderColor =
//                     errors.photo ? '#dc3545' : '#C8B8AE')
//                 }
//               >
//                 <KTIcon iconName='picture' className='fs-2x text-muted' />
//                 <p style={{margin: '6px 0 0', fontSize: '12px', color: '#9e9992'}}>
//                   Klik atau ambil foto kamera
//                 </p>
//               </div>
//             )}
//           </div>
...
//             ) : (
//               <>
//                 <KTIcon iconName='send' className='fs-5' />
//                 Kirim Laporan
//               </>
//             )}
//           </button>
...
export const FaultyItemModal: FC<FaultyItemModalProps> = ({item, onClose, onSuccess}) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      formData.append('faulty_quantity', String(qty))
      formData.append('description', description)
      if (photoFile) formData.append('image', photoFile) // ← field 'image' sesuai backend
  ...
  return (
    <>
      ...
      <div style={{position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1050, backgroundColor: '#fff', borderRadius: '20px', width: '92%', maxWidth: '460px', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 32px 80px rgba(0,0,0,0.20)', padding: '28px'}}>
            ...
            {photoPreview ? (
              <div style={{position: 'relative'}}>
                ...
                <button
                  ...
                  style={{position: 'absolute', top: '6px', right: '6px', width: '24px', height: '24px', borderRadius: '50%', border: 'none', backgroundColor: 'rgba(0,0,0,0.55)', color: '#fff', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', lineHeight: 1}}
                >×</button>
              </div>
            ) : (
              <div
                onClick={() => fileInputRef.current?.click()}
                style={{border: `2px dashed ${errors.photo ? '#dc3545' : '#C8B8AE'}`, borderRadius: '8px', padding: '20px', textAlign: 'center', cursor: 'pointer', backgroundColor: errors.photo ? '#fff5f5' : '#faf6f2'}}
        ...
        {errors.photo && <p style={{color: '#dc3545', fontSize: '12px', marginBottom: '20px', paddingLeft: '4px'}}>{errors.photo}</p>}
